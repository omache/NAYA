<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentBitcoin.aspx.cs" Inherits="HopeForHumanity.PaymentBitcoin" %>
...
<head runat="server">
    ...
    <title>Bitcoin - Hope For Humanity</title>
    ...
    <form id="form1" runat="server">
        <div id="wrapper">
            ...
            <div id="main">
                ...
                <div class="breadcrumb-section bitcoin-breadcrumb-section">
                </div>
                ...
                <section class="container" id="page-info">
                    <div class="row">
                        ...
                        <div class="col-xs-12 payment-success-box">
                            <strong>Scan the following QR code in your bitcoin wallet:</strong>
                            <div class="hand-pics">
                                <%--<img src="assets/svg/heart-thanks.svg" alt="" class="svg" />--%>
                                <img src="assets/img/bitcoinqr.png" alt="" class="hand-shake" height="141" width="233" />
                            </div>
                            <br />
                            <header class="page-header">
                                <h2>Or you can use the address: ​15rfUgLGDrTUAJTezgG2Pu9tARmhYjmbpW</h2>
                                <h2>Your donation towards Hope for Humanity is highly appreciated. Thanks for Your Help.</h2>
                                <p>
                                    We would recommend you to see some other causes if you would like to donate more, including medical care, shelter, etc. Click below for more.									
                                </p>
                                <a class="btn btn-default btn-again" href="Default.aspx">HOME</a>
                            </header>
                        </div>
                    </div>
                </section>
