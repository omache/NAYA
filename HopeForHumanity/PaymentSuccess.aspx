<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentSuccess.aspx.cs" Inherits="HopeForHumanity.PaymentSuccess" %>
...
<head runat="server">
    ...
    <title>Success - Hope For Humanity</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 payment-success-box">
                            ...
                            <header class="page-header">
                                <h2>Your donation towards Hope for Humanity has been submitted successfully. Thanks for Your Help.</h2>
                                <p>
